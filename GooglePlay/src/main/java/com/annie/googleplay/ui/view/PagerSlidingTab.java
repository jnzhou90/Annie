...
public class PagerSlidingTab extends HorizontalScrollView {
	...
	private int tabTextColor = 0xFF666666; //标题颜色
	private Typeface tabTypeface = null;
	private int tabTypefaceStyle = Typeface.BOLD; //标题字体,粗体
	...
	public void notifyDataSetChanged() {
		...
		tabCount = pager.getAdapter().getCount();//7
